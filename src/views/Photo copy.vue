...
<script>  
    ...
    import scan from "../assets/hongbao.png";//遮罩图片    
    export default {    
        data() {      
            return {        
                showLoading:false,        
